...
# Tensorflow v2.1.0 (CPU) -------------------------------------------------------

CONTAINER_TENSORFLOW21_CPU_CONDA_ENV_FILES =\
    $(CONTAINER_TENSORFLOW21_CPU_INCLUDE_DIR)/environment-worker-tf21.yml
...
CONTAINER_TENSORFLOW21_GPU_CONDA_ENV_FILES =\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/environment-worker-tf21.yml
CONTAINER_TENSORFLOW21_GPU_INCLUDE_FILES =\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/aws-config\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/bash.bashrc\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/dot-condarc\
    $(CODE_BUILD_DIR)/$(subst -,_,$(CODE_PKG_NAME))-$(CODE_PKG_VERSION)-py3-none-any.whl
CONTAINER_TENSORFLOW21_GPU_SCRIPTS =\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/entrypoint-worker.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/fix-permissions.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/parse-uri.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/run-mlflow-job.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/s3-cp.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/s3-mb.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/s3-sync.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/secure-container.sh\
    $(CONTAINER_TENSORFLOW21_GPU_INCLUDE_DIR)/unpack-archive.sh
